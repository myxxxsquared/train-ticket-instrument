...
public class ConsignController { 
    ...
    public HttpEntity insertConsign(@RequestBody Consign request,
        ...
        logger.info("[function name:{}][request:{}, headers:{}]","insertConsign",(request != null ? request.toString(): null), (headers != null ? headers.toString(): null));
    ...
    public HttpEntity updateConsign(@RequestBody Consign request, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][request:{}, headers:{}]","updateConsign",(request != null ? request.toString(): null), (headers != null ? headers.toString(): null));
    ...
    public HttpEntity findByAccountId(@PathVariable String id, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][id:{}, headers:{}]","findByAccountId",id, (headers != null ? headers.toString(): null));
    ...
    public HttpEntity findByOrderId(@PathVariable String id, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][id:{}, headers:{}]","findByOrderId",id, (headers != null ? headers.toString(): null));
        UUID newid = UUID.fromString(id);
    ...
    public HttpEntity findByConsignee(@PathVariable String consignee, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][consignee:{}, headers:{}]","findByConsignee",consignee, (headers != null ? headers.toString(): null));
