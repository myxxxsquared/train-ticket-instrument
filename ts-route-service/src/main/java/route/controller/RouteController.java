...
public class RouteController { 
    ...
    public ResponseEntity<Response> createAndModifyRoute(@RequestBody RouteInfo createAndModifyRouteInfo, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][createAndModifyRouteInfo:{}, headers:{}]","createAndModifyRoute",(createAndModifyRouteInfo != null ? createAndModifyRouteInfo.toString(): null), (headers != null ? headers.toString(): null));
    ...
    public HttpEntity queryById(@PathVariable String routeId, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][routeId:{}, headers:{}]","queryById",routeId, (headers != null ? headers.toString(): null));
    ...
    public HttpEntity queryByIds(@RequestBody List<String> routeIds, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][routeIds:{}, headers:{}]","queryByIds",(routeIds != null ? routeIds.toString(): null), (headers != null ? headers.toString(): null));
    ...
    public HttpEntity queryByStartAndTerminal(@PathVariable String start,
        ...
        logger.info("[function name:{}][start:{}, end:{}, headers:{}]","queryByStartAndTerminal",start, end, (headers != null ? headers.toString(): null));
