...
public class AdminBasicInfoController { 
    ...
    public HttpEntity modifyContacts(@RequestBody Contacts mci, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][mci:{}, headers:{}]","modifyContacts",(mci != null ? mci.toString(): null), (headers != null ? headers.toString(): null));
    ...
    public HttpEntity addContacts(@RequestBody Contacts c, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][c:{}, headers:{}]","addContacts",(c != null ? c.toString(): null), (headers != null ? headers.toString(): null));
