...
public class ConfigController { 
    ...
    public HttpEntity<?> createConfig(@RequestBody Config info, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][info:{}, headers:{}]","createConfig",(info != null ? info.toString(): null), (headers != null ? headers.toString(): null));
    ...
    public HttpEntity updateConfig(@RequestBody Config info, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][info:{}, headers:{}]","updateConfig",(info != null ? info.toString(): null), (headers != null ? headers.toString(): null));
    ...
    public HttpEntity deleteConfig(@PathVariable String configName, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][configName:{}, headers:{}]","deleteConfig",configName, (headers != null ? headers.toString(): null));
    ...
    public HttpEntity retrieve(@PathVariable String configName, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][configName:{}, headers:{}]","retrieve",configName, (headers != null ? headers.toString(): null));
