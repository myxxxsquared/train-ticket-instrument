...
public class ConsignPriceController { 
    ...
    public HttpEntity getPriceByWeightAndRegion(@PathVariable String weight, @PathVariable String isWithinRegion,
        ...
        logger.info("[function name:{}][String:{}, String:{}, HttpHeaders:{}]","getPriceByWeightAndRegion",weight, isWithinRegion, (headers != null ? headers.toString(): null));
    ...
    public HttpEntity getPriceInfo(@RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][HttpHeaders:{}]","getPriceInfo",(headers != null ? headers.toString(): null));
    ...
    public HttpEntity getPriceConfig(@RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][HttpHeaders:{}]","getPriceConfig",(headers != null ? headers.toString(): null));
    ...
    public HttpEntity modifyPriceConfig(@RequestBody ConsignPrice priceConfig,
                                        @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][ConsignPrice:{}, HttpHeaders:{}]","modifyPriceConfig",(priceConfig != null ? priceConfig.toString(): null), (headers != null ? headers.toString(): null));
