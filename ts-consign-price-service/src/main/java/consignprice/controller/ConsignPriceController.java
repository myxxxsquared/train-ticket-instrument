...
public class ConsignPriceController { 
    ...
    public HttpEntity getPriceInfo(@RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][headers:{}]","getPriceInfo",(headers != null ? headers.toString(): null));
    ...
    public HttpEntity modifyPriceConfig(@RequestBody ConsignPrice priceConfig,
                                        @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][priceConfig:{}, headers:{}]","modifyPriceConfig",(priceConfig != null ? priceConfig.toString(): null), (headers != null ? headers.toString(): null));
