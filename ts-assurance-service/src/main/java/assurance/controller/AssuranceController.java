...
public class AssuranceController { 
    ...
    public HttpEntity getAllAssuranceType(@RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][headers:{}]","getAllAssuranceType",(headers != null ? headers.toString(): null));
    ...
    public HttpEntity deleteAssurance(@PathVariable String assuranceId, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][assuranceId:{}, headers:{}]","deleteAssurance",assuranceId, (headers != null ? headers.toString(): null));
    ...
    public HttpEntity deleteAssuranceByOrderId(@PathVariable String orderId, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][orderId:{}, headers:{}]","deleteAssuranceByOrderId",orderId, (headers != null ? headers.toString(): null));
    ...
    public HttpEntity modifyAssurance(@PathVariable String assuranceId,
        ...
        logger.info("[function name:{}][assuranceId:{}, orderId:{}, typeIndex:{}, headers:{}]","modifyAssurance",assuranceId, orderId, typeIndex, (headers != null ? headers.toString(): null));
    ...
    public HttpEntity createNewAssurance(@PathVariable int typeIndex, @PathVariable String orderId, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][typeIndex:{}, orderId:{}, headers:{}]","createNewAssurance",typeIndex, orderId, (headers != null ? headers.toString(): null));
    ...
    public HttpEntity getAssuranceById(@PathVariable String assuranceId, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][assuranceId:{}, headers:{}]","getAssuranceById",assuranceId, (headers != null ? headers.toString(): null));
    ...
    public HttpEntity findAssuranceByOrderId(@PathVariable String orderId, @RequestHeader HttpHeaders headers) {
        logger.info("[function name:{}][orderId:{}, headers:{}]","findAssuranceByOrderId",orderId, (headers != null ? headers.toString(): null));
